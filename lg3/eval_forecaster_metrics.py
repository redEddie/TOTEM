...
def main():
    parser = argparse.ArgumentParser(description="Evaluate forecaster and export per-sequence metrics")
    ...
    parser.add_argument("--output_csv", type=str, default="lg3/results/forecast_metrics.csv")
    parser.add_argument("--output_seq_mse_csv", type=str, default="lg3/results/forecast_seq_mse.csv")
    parser.add_argument("--output_seq_mae_csv", type=str, default="lg3/results/forecast_seq_mae.csv")
    parser.add_argument("--output_seq_mape_csv", type=str, default="lg3/results/forecast_seq_mape.csv")
    parser.add_argument("--output_seq_mase_csv", type=str, default="lg3/results/forecast_seq_mase.csv")

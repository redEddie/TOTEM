...
from lg3.lib.models.core import BaseModel
    ...
    def __init__(
        ...
        if compression_factor == 4:
            ...
            self._conv_3 = nn.Conv1d(
                in_channels=num_hiddens, out_channels=num_hiddens, kernel_size=3, stride=1, padding=1
            )
...
class Decoder(nn.Module):
    def __init__(
        ...
        if compression_factor == 4:
            self._conv_1 = nn.Conv1d(
                in_channels=embedding_dim, out_channels=num_hiddens, kernel_size=3, stride=1, padding=1
            )
            self._residual_stack = ResidualStack(
                in_channels=num_hiddens,
                num_hiddens=num_hiddens,

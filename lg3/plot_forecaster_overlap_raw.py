...
def main():
    parser = argparse.ArgumentParser(description="Plot overlapping raw forecasts vs ground truth")
    ...
    parser.add_argument("--output", type=str, default="lg3/results/forecast_overlap_power_raw.png")
